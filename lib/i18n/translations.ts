export const translations = {
  en: {
    ...
    form_success_message: "We have received your demo request. Our team will contact you on WhatsApp shortly to set up your restaurant.",
    form_optional_suffix: " (Optional)",
    moroccan_cities: ["Casablanca", "Rabat", "Marrakech", "Tangier", "Agadir", "Fes", "Meknes", "Oujda", "Kenitra", "Tetouan", "Other"],
    ...
    contact_form_message_placeholder: "Describe what you need…",
    contact_form_submit: "Send Message",
    contact_form_success_title: "Message Sent",
    contact_form_success_message: "Thanks for reaching out. Our team will get back to you shortly at the email you provided.",
    contact_form_error_generic: "Something went wrong. Please try again or email us directly.",
    ...
    tier_starter_features: ["PWA + QR Menu", "WhatsApp (orders + alerts)", "1 KDS screen", "CRM capture with consent", "Grace buffer (25 orders)", "1 POS"],
  ...
  fr: {
    ...
    // Hero
    hero_tag: "// MOTEUR EN SERVICE : OPÉRATIONNEL SUR CASABLANCA & SETTAT",
    ...
    form_success_message: "Nous avons bien reçu votre demande de démonstration. Notre équipe vous contactera prochainement sur WhatsApp pour configurer votre restaurant.",
    form_optional_suffix: " (Facultatif)",
    moroccan_cities: ["Casablanca", "Rabat", "Marrakech", "Tanger", "Agadir", "Fès", "Meknès", "Oujda", "Kénitra", "Tétouan", "Autre"],
    ...
    footer_desc_2: "« GEQO LLC est le fournisseur technologique ; GEQO SARL AU gère les services aux marchands locaux. »",
    ...
    footer_rights: "© 2026 GEQO SARL AU. TOUS DROITS RÉSERVÉS.",
    footer_contact: "Contact",
    ...
    contact_form_message_placeholder: "Décrivez votre besoin…",
    contact_form_submit: "Envoyer le Message",
    contact_form_success_title: "Message Envoyé",
    contact_form_success_message: "Merci de nous avoir contactés. Notre équipe vous répondra sous peu à l'adresse indiquée.",
    contact_form_error_generic: "Une erreur est survenue. Veuillez réessayer ou nous écrire directement.",
    ...
    tier_starter_features: ["PWA + Menu QR", "WhatsApp (commandes + alertes)", "1 écran KDS", "Capture CRM avec consentement", "Marge de grâce (25 commandes)", "1 point de vente"],
    ...
    tier_starter_wallet: "Recharge initiale : 149 MAD TTC (soit 124 MAD HT — ≈ 50 commandes) ; recharges suivantes à partir de 50 MAD ; recharge automatique optionnelle (sous les 30 MAD)",
    tier_pro_name: "PRO",
    tier_pro_price: "599 MAD",
    tier_pro_period: "/ mois TTC",
    tier_pro_ht: "soit 499 MAD HT",
    tier_pro_founder: "499 MAD / mois TTC",
    tier_pro_features: ["Commandes illimitées (0 MAD par commande)", "2 écrans KDS", "3 livreurs avec dispatch + code PIN à 4 chiffres", "Géo-clôture de livraison", "CRM complet + statistiques avancées"],
    ...
    tier_scale_features: ["Commandes illimitées", "Écrans KDS et livreurs illimités", "CRM complet + campagnes WhatsApp Boost", "Fidélité / Parrainage", "Export CRM brut", "Support prioritaire"],
    tier_scale_micro: "Scale = votre facture Mymenu… avec la cuisine et les livreurs inclus.",
    tier_multi_name: "MULTI",
    tier_multi_price: "2 099 MAD",
    tier_multi_period: "/ mois TTC",
    tier_multi_ht: "soit 1 749 MAD HT",
    tier_multi_founder: "1 799 MAD / mois TTC",
    tier_multi_features: ["Jusqu'à 5 points de vente (+349 MAD TTC / point de vente supplémentaire)", "Pack Scale complet", "Gestionnaire dédié"],
  ...
  ar: {
    ...
    form_success_message: "لقد تلقينا طلب العرض التجريبي الخاص بك. سيتصل بك فريقنا قريباً عبر واتساب لإعداد مطعمك.",
    form_optional_suffix: " (اختياري)",
    moroccan_cities: ["الدار البيضاء", "الرباط", "مراكش", "طنجة", "أكادير", "فاس", "مكناس", "وجدة", "القنيطرة", "تطوان", "أخرى"],
    ...
    contact_form_message_placeholder: "صف احتياجك…",
    contact_form_submit: "إرسال الرسالة",
    contact_form_success_title: "تم إرسال الرسالة",
    contact_form_success_message: "شكراً لتواصلكم معنا. سيقوم فريقنا بالرد عليكم قريباً على العنوان الذي قدمتموه.",
    contact_form_error_generic: "حدث خطأ. يرجى المحاولة مرة أخرى أو مراسلتنا مباشرة.",
    ...
    tier_starter_features: ["PWA + قائمة QR", "واتساب (طلبات + تنبيهات)", "شاشة KDS واحدة", "التقاط CRM مع الموافقة", "هامش ثقة (25 طلب)", "نقطة بيع واحدة"],
